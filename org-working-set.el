...
(defvar org-working-set-version "2.1.5" "Version of `org-ẃorking-set', format is major.minor.bugfix, where \"major\" are incompatible changes and \"minor\" are new features.")
...
This is version 2.1.5 of org-working-set.el.
